# Microsoft Developer Studio Project File - Name="usbprobe" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=usbprobe - Win32 Checked
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "usbprobe.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "usbprobe.mak" CFG="usbprobe - Win32 Checked"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "usbprobe - Win32 Free" (based on "Win32 (x86) Application")
!MESSAGE "usbprobe - Win32 Checked" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 wdm.lib usbd.lib /nologo /base:"0x10000" /version:4.0 /entry:"DriverEntry@8" /subsystem:windows /pdb:none /machine:I386 /nodefaultlib /out:"objfre\i386\usbprobe.sys" /libpath:"$(DDKPATH)\libfre\i386" -MERGE:_PAGE=PAGE -MERGE:_TEXT=.text -MERGE:.rdata=.text -SECTION:INIT,d -OPT:REF -FORCE:MULTIPLE -RELEASE -FULLBUILD -IGNORE:4001,4037,4039,4065,4070,4078,4087,4089,4096 -osversion:4.00 -optidata -driver -align:0x20 -subsystem:native,4.00 -debug:notmapped,minimal
# ADD LINK32 wdm.lib usbd.lib /nologo /base:"0x10000" /version:4.0 /entry:"DriverEntry@8" /subsystem:windows /pdb:none /machine:I386 /nodefaultlib /out:"objfre\i386\usbprobe.sys" /libpath:"$(DDKPATH)\libfre\i386" -MERGE:_PAGE=PAGE -MERGE:_TEXT=.text -MERGE:.rdata=.text -SECTION:INIT,d -OPT:REF -FORCE:MULTIPLE -RELEASE -FULLBUILD -IGNORE:4001,4037,4039,4065,4070,4078,4087,4089,4096 -osversion:4.00 -optidata -driver -align:0x20 -subsystem:native,4.00 -debug:notmapped,minimal
# Begin Custom Build - Finishing up...
IntDir=.\Release
TargetPath=.\objfre\i386\usbprobe.sys
TargetName=usbprobe
InputPath=.\objfre\i386\usbprobe.sys
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "usbprobe - Win32 Checked"
...
# Name "usbprobe - Win32 Free"
# Name "usbprobe - Win32 Checked"
