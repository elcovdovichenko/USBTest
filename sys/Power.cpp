// Power request handler usbprobe driver
...
/* FinalState */			{InvalidAction,		InvalidAction,				InvalidAction},
	...
	while (TRUE)
		...
		case DevPowerUpComplete:
			...
			pdx->IoctlAbortStatus = 0;	// okay to accept new IOCTLs now			
		...
		case SaveContext:
			...
			// Abort and pending IOCTL operations that are still outstanding
