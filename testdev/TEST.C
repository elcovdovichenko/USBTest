...
int _cdecl main (int argc, char *argv[])
{
    ...
    OutputDebugString("\nOpening the device USBPROBE\n");

    printf("\nOpening the device USBPROBE\n");

    file = CreateFile ( "\\\\.\\USBPROBE_0",
    ...
    {
        printf("USBPROBE: Wow - it really worked!!!\n");
        ...
        */
        ...
        OutputDebugString("Closeing the device USBPROBE\n");
